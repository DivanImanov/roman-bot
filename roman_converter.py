...
print(roman_converter('DCCCCLXXXXIX'))
print(roman_converter('XVI'))
print(roman_converter('XIV'))
print(roman_converter('CXX'))
print()
print(roman_converter('III'))
print(roman_converter('LVIII'))
print(roman_converter('MCMXCIV'))
